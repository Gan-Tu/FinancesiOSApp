...
enum DemoData {
    ...
    static func systemEntryFixture() -> JournalData {
        ...
        data.transactions = [
            ...
            LedgerTransaction(id: id(101), ledgerID: id(1), date: Date().addingTimeInterval(-60), payee: "SYNTHETIC Payment", note: "SYNTHETIC Received Payment", number: "SYN-PAYMENT", cleared: true,
