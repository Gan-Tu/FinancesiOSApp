...
| Authorized TestFlight release | Independent App Store Connect app 6809320145 created; beta contact information and Gmail tester saved; build 1.0.0 (3) uploaded and submitted with the latest square icon and template ordering | Submitted; waiting for Apple beta review |
