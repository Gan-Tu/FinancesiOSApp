...
| Authorized TestFlight release | Independent App Store Connect app 6809320145 created; beta contact information and Gmail tester saved; build 1.0.0 (2) uploaded after revising the icon | Submitted; waiting for Apple beta review |
