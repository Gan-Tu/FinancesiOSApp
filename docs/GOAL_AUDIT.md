...
| Distribution setup | App Store-signed IPA exported with cloud-managed signing; Production/APNs entitlements and App Store profile checked; archive/export scripts, successful GitHub CI, and configured Xcode Cloud release on main | First push-triggered release pending |
| Authorized TestFlight release | Independent App Store Connect app 6809320145 created; Gmail external tester saved; build 1.0.0 (3) submitted externally and assigned internally with the requested Hotmail invitation | Internal tester invited; external beta review pending |
